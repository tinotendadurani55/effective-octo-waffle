    ...
    ytv: {
        ...
        async execute(ctx) {
            ...
            try {
                ...
                const command = `/data/data/com.termux/files/usr/bin/yt-dlp -f 'bestvideo[height<=360][ext=mp4]+bestaudio[ext=m4a]/best[height<=360][ext=mp4]/best[ext=mp4]' --no-mtime -o "${outputFileName}" "${videoUrl}"`;
    ...
    play: {
        ...
        async execute(ctx) {
            ...
            try {
                ...
                const command = `/data/data/com.termux/files/usr/bin/yt-dlp -x --audio-format mp3 --audio-quality 5 --no-mtime -o "${outputFileName}" "${video.url}"`;
...
async function startBot() {
    ...
    const sock = makeWASocket({
        ...
        // ✅ BUG FIX: messages.js:522 Runtime Error Check
